...
class Apple: #Class, met het ID "Apple"
    def __init__(self, parent_screen):#Defenitie met tijdelijke variablen
        ...
        if random.random()<1:
            self.image = pygame.image.load("resources/test.png").convert() #Laad het plaatje naar het scherm
        else:
            self.image = pygame.image.load("resources/Tibo.png").convert()
        self.x = 120 #vak-grootte
        self.y = 120
